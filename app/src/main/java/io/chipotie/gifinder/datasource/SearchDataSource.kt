...
@Inject
constructor(private val gifinderApi: GifinderApi, private val query: String, private val retryExecutor: Executor) :
    ...
    override fun loadInitial(
        ...
        gifinderApi.search(BuildConfig.API_KEY, query, params.requestedLoadSize, 0).enqueue(object :
    ...
    override fun loadAfter(params: LoadParams<Long>, callback: LoadCallback<Long, Gif>) {
        ...
        gifinderApi.search(BuildConfig.API_KEY, query, params.requestedLoadSize, params.requestedLoadSize * params.key).enqueue(object :
            Callback<GifResponse> {
            override fun onFailure(call: Call<GifResponse>, t: Throwable) {
                retry = {
